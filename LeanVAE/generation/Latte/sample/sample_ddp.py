...
def main(args):
    ...
    vae = LeanVAE.load_from_checkpoint(args.vae_path, strict=False).to(device)
    ...
    for _ in pbar:
        # Sample inputs:
        latent_dim = args.in_channels 
        num_frames = 1 + (args.num_frames - 1) // 4
        ...
        samples = vae.decode(samples / norm_param)
